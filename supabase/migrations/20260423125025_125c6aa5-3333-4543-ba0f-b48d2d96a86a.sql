-- Gate admin features by client.enabled_modules so that
-- modules NOT enabled for the tenant are hidden even from admins.
...
BEGIN
  ...
  SELECT
    ...
    CASE
      ...
      -- Module gating applies to ALL non-super roles (admin, hr, employee).
